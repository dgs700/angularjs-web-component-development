...
module.exports = function (grunt) {
    ...
    var escapeContent = function (content, quoteChar, indentString) {
        ...
        var nlReplace = quoteChar + ' +\n' + indentString + indentString + quoteChar;

        //the following line was failing on escaped single quotes inside double quote in the html -
        //return content.replace(bsRegexp, '\\\\').replace(quoteRegexp, '\\' + quoteChar).replace(/\r?\n/g, nlReplace);
        return content.replace(bsRegexp, '\\').replace(/\r?\n/g, nlReplace);
    };
    ...
    grunt.registerMultiTask('html2jsVar', 'Compiles Angular-JS templates to JavaScript.', function () {
